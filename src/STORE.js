...
let stageArray = participants.filter(person => person.onStage);
let inSessionArray = participants.filter(person => person.inSession);
let notInSessionArray = participants.filter(person => !person.inSession)
let chatArray = chatEvents.filter(person => person.message);
